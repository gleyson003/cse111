...
def print_death_age(people_dict):
    ...
    for item in people_dict.items():
        ...
        death_age = value[death_year_index] - value[birth_year_index]
...
def print_marriages(marriages_dict, people_dict):
    ...
    for item in marriages_dict.items():
        ...
        husband_data = people_dict[value[husband_key_index]]
        husband_name = husband_data[0]
        husband_age_wedding = wedding_year - husband_data[2]

        wife_data = people_dict[value[wife_key_index]]
        wife_name = wife_data[0]
        wife_age_wedding = wedding_year - wife_data[2]

        print(f'{husband_name} {husband_age_wedding} > {wedding_year} < {wife_name} {wife_age_wedding}')
