...
import pytest
from water_flow import pressure_loss_from_pipe_reduction, water_column_height, \
...
def test_pressure_gain_from_water_height():
    pressure_gain_from_water_height(0) == 0
    pressure_gain_from_water_height(30.2) == approx(295.628, abs=0.0001)
    pressure_gain_from_water_height(50) == approx(489.450, abs=0.0001)
...
def test_reynolds_number():
    ...
    assert reynolds_number(0.048692, 1.65) == approx(471729, abs=1)
    assert reynolds_number(0.048692, 1.75) == approx(500318, abs=1)
