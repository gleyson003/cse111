...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol in symbol_quantity_list:
        word_symbol = symbol[0]
        times_symbol = symbol[1]
        symbol_atomic_mass = periodic_table_dict[word_symbol][1]

        molar_mass = symbol_atomic_mass * times_symbol
...
def main():
    ...
    periodic_elements_list = make_periodic_table()
    elements_symbols_list = parse_formula(molecular_formula, periodic_elements_list)
    molar_mass = compute_molar_mass(elements_symbols_list, periodic_elements_list)
    
    moles = mass_grams / molar_mass
    formula_name = get_formula_name(molecular_formula, known_molecules_dict)

    print(f'{formula_name.capitalize()} \n'
          f'{molar_mass} grams/mole \n'
          f'{moles:0.5f} moles')
